...
import org.calypsonet.keyple.plugin.coppernic.example.adapter.EventAdapter
import org.calypsonet.keyple.plugin.coppernic.example.model.ChoiceEventModel
import org.calypsonet.keyple.plugin.coppernic.example.model.EventModel
import org.calypsonet.keyple.plugin.coppernic.example.util.CalypsoClassicInfo.SAM_PROFILE_NAME
...
abstract class AbstractExampleActivity : AppCompatActivity(),
    NavigationView.OnNavigationItemSelectedListener, CardReaderObserverSpi,
    ...
    internal class ReaderConfigurator : ReaderConfiguratorSpi {
        ...
        override fun setupReader(reader: Reader) {
            ...
            try {
                reader
                    .getExtension(Cone2ContactReader::class.java)

...
class MainActivity : AbstractExampleActivity() {
  ...
  override fun initReaders() {
    ...
    GlobalScope.launch {
      ...
      // Register the Coppernic with SmartCardService, get the corresponding generic Plugin in
      // return
      ...
      (poReader as ConfigurableCardReader).activateProtocol(cardProtocol.name, cardProtocol.name)
      ...
      (samReader as ConfigurableCardReader).activateProtocol(
      ...
      if (selectionsResult.activeSelectionIndex != -1) {
        ...
        val poTransaction =
            if (withSam) {
              ...
              calypsoCardExtensionProvider.createCardTransactionWithoutSecurity(poReader, calypsoPo)
            }
